import{B as Ma,N as Zu}from"./Button-0y_jw6Ox.js";import{_ as fy,N as py,a as my,u as gy}from"./Popconfirm-DKduHflq.js";import{d as yf,j as eh,k as _y,c as vf,o as Ef,f as yy,e as ut,l as th,w as Bt,am as qt,A as Bi}from"./index-CyoENmfz.js";import{_ as vy}from"./Space-BssLjcfg.js";import"./Checkbox-CdWkDD3L.js";import"./Tooltip-C0olq5si.js";import"./Dropdown-DvYTXzsF.js";const Ey=()=>{};var nh={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hw(n){nE(On),lt(new Ze("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return rw(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),qe(ph,mh,n),qe(ph,mh,"esm2017")}Rt.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};Rt.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};hw();const dw={style:{"margin-bottom":"16px"}},sr="yuexiu/template/editTable1",fw=yf({__name:"editTable1",setup(n){const e=cw(),t=eh(!0),i=eh([]);_y(()=>{const c=ir(e,sr);tw(c,u=>{const f=u.val()||{},p=Object.entries(f).map(([g,T])=>({key:g,...T}));i.value=p,t.value=!1})});const s=c=>{const u=ir(e,"".concat(sr,"/").concat(c.key));Ia(u,{name:c.name,age:c.age,address:c.address})},r=async()=>{const c=ZI(ir(e,sr)),u={name:"",age:0,address:""};try{await Ia(c,u)}catch(f){}},o=c=>{const u=ir(e,"".concat(sr,"/").concat(c.key));Ia(u,null)},l=[{title:"序号",key:"index",render:(c,u)=>u+1},{title:"名称",key:"name",render(c){return Bi(Zu,{value:c.name,onUpdateValue:u=>{c.name=u,s(c)}})}},{title:"年龄",key:"age",render(c){return Bi(py,{value:c.age,type:"number",onUpdateValue:u=>{c.age=parseInt(u)||0,s(c)}})}},{title:"地址",key:"address",render(c){return Bi(Zu,{value:c.address,onUpdateValue:u=>{c.address=u,s(c)}})}},{title:"操作",key:"actions",render(c){return Bi(my,{onPositiveClick:()=>o(c.key),positiveText:"确认",negativeText:"取消"},{trigger:()=>Bi(Ma,{size:"small",type:"error"},{default:()=>"删除"}),default:()=>"你确定要删除这条记录吗？"})}}];return(c,u)=>(Ef(),vf("div",null,[yy("div",dw,[ut(th(Ma),{type:"primary",onClick:r},{default:Bt(()=>u[0]||(u[0]=[qt("新增一行")])),_:1})]),ut(th(fy),{columns:l,data:i.value,loading:t.value,pagination:!1,empty:()=>"暂无数据，请点击下方新增按钮添加"},null,8,["data","loading"])]))}});var Qh=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
